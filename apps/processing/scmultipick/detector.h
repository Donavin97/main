...
#ifndef APPS_MULTIPICK_DETECTOR_H
#define APPS_MULTIPICK_DETECTOR_H
...
class Detector : public Processing::SimpleDetector {
	public:
		...
		void setAmplitudeFilter(const std::string &filter);
	...
	private:
		...
		std::string  _amplFilterStr;
		Core::SmartPointer<Math::Filtering::InPlaceFilter<double>> _amplFilter;
};
