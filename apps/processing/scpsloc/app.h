...
class App : public Client::Application, protected ::PSLoc::Autoloc3
{
	public:
	...
	protected:
		...
		bool _report(const ::PSLoc::Origin *origin) override;
//		bool runFromPickFile();
	...
	protected:
//		DataModel::Origin *convertToSC  (const ::PSLoc::Origin* origin, bool allPhases=true);
		::PSLoc::Origin *convertFromSC(const DataModel::Origin* scorigin);
		::PSLoc::Pick   *convertFromSC(const DataModel::Pick*   scpick);
